function [ pgm_feature ] = get_feature_acoustic( fpath, params,label,start_time, stop_time )
...
[u, sigma ] = compute_PGM_New(x_t_cut, fs, t_cut, params.win_size, params.hop_size,...
